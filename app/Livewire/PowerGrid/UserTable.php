...
final class UserTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Tipo sangre', 'tipo_sangre')
                ->sortable()
                ->searchable(),

            Column::make('No licencia', 'no_licencia')
                ->sortable()
                ->searchable(),

            Column::make('Inicio labores', 'inicio_labores_formatted', 'inicio_labores')
                ->sortable(),

            Column::make('Fin labores', 'fin_labores_formatted', 'fin_labores')
                ->sortable(),
