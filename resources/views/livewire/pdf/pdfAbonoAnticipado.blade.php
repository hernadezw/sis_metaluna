...
<table style="border-collapse:collapse;margin-left:5.93pt" cellspacing="0">
    ...
    <tr style="height:13pt">
        ...
        <p class="s2" style="text-indent: 0pt;line-height: 12pt;text-align: center;">VENTA:</p>
        </td>
...
<tr style="height:13pt">
    ...
    <p class="s3" style="text-indent: 0pt;text-align: center;">{{$abono['no_abono']}}</p>
    </td>
    <td style="width:95pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    ...
    <td style="width:95pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s3" style="padding-right: 4pt;text-indent: 0pt;text-align: center;">Q. {{$abono['total_abono']}}</p>
    </td>
    <td style="width:95pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
    <p class="s3" style="padding-right: 4pt;text-indent: 0pt;text-align: center;">Q. {{$abono['total_saldo']}}</p>
    </td>
</tr>
<tr style="height:13pt">
    <td style="width:570 pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt" colspan="6" >
        <p class="s3" style="padding-right: 4pt;text-indent: 0pt;line-height: 12pt;text-align: star;">Observaciones: {{$abono['observaciones']}}</p>
    </td>
</tr>

<tr style="height:13pt">
    <td style="width:95pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"colspan="3">
...
<tr style="height:13pt">
    <td style="width:570 pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt" colspan="6" >
        <p class="s3" style="padding-right: 4pt;text-indent: 0pt;line-height: 12pt;text-align: star;">Detalle Pago: {{$abono['detalle_pago']}}</p>
    </td>
</tr>
