    ...
    <div class="lg:flex gap-4 items-stretch">
            ...
            <div class="flex flex-wrap justify-between h-full">
                <div class="w-1/2 xl:w-1/3 px-3">
                    <div class="w-full bg-white border text-orange-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
                      ...
                      <div class="text-gray-700">
                        <p class="font-semibold text-3xl">{{$ventas_del_dia}}</p>
                ...
                <div class="w-1/2 xl:w-1/3 px-3">
                    <div class="w-full bg-white border text-orange-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
                      ...
                      <div class="text-gray-700">
                        <p class="font-semibold text-3xl">{{$productos_baja_existencia_canitdad}}</p>
                ...
                <div class="w-1/2 xl:w-1/3 px-3">
                    <div class="w-full bg-white border text-orange-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
                      ...
                      <div class="text-gray-700">
                        <p class="font-semibold text-3xl">{{$creditos_cantidad}}</p>
